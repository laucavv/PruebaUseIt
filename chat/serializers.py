...
class SerializerMessage(serializers.ModelSerializer):
    ...
    sender = serializers.SlugRelatedField(many=False, slug_field='username', queryset=User.objets.all())
    receiver = serializers.SlugRelatedField(many=False, slug_field='username', queryset=User.objets.all())
